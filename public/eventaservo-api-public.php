 ...
 * @subpackage Wp_Plugin_Eventaservo_Api/public
 */
...
class Eventaservo_Api_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Wp_Plugin_Eventaservo_Api_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Wp_Plugin_Eventaservo_Api_Loader will then create the relationship
